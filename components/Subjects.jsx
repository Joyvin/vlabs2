    ...
    <>
      <div className="lg:m-16">
        <div className="w-full my-10 flex justify-center">
          <div className="title text-5xl lg:text-7xl">Get Started</div>
        </div>
        <div className="flex justify-center">
          <div className="grid md:grid-cols-2 grid-cols-1 lg:ml-16 gap-10 px-10 lg:px-0 pb-10 w-full lg:w-[50%] ">
            <div className="">
              <Link
                style={{
                  background: "url('/img/home/3.png') top no-repeat",
                  ...
                  <div className="flex justify-around">
                    <div className="">
                      <div className="text-center">
                        <strong className="xl:text-4xl text-2xl">13</strong>
                      </div>
                      <div className="text-center">
                    ...
                    <div className="">
                      <div className="text-center">
                        <strong className="xl:text-4xl text-2xl">18</strong>
                      </div>
                      <div className="text-center">
            ...
            <div className="">
              <Link
                style={{
                  background: "url('/img/home/2.png') top no-repeat",
                  backgroundSize: "cover",
                }}
                href="/ds"
              ...
              >
                ...
                <div className="bg-white w-full rounded-b-3xl h-[30%] flex flex-col justify-center">
                  <div className="flex justify-around">
                    <div className="">
                      <div className="text-center">
                        <strong className="xl:text-4xl text-2xl">12</strong>
                      </div>
                      <div className="text-center">
                        <span className="text-xl">Chapters</span>
                      </div>
                    ...
                    <div className="">
                      <div className="text-center">
                        <strong className="xl:text-4xl text-2xl">24</strong>
                      </div>
                      <div className="text-center">
                        <span className="text-xl">Challenges</span>
                      </div>
